<div class="container">
    <section class="slider_area">
        <div class="forcefullwidth_wrapper_tp_banner" id="home-slider_forcefullwidth">
        </div>
...
<section class="download_area" style="background-image: url(templates/themes/base/img/download_bg.jpg)">
                ...
                <div class="item">
                    <div class="col-md-7">
                        <div class="download_app_icon">
                            <h3>Download <span>{site_name}</span> app</h3>
                        ...
                        <div class="download_content owl-carousel owl-theme owl-loaded">
                    ...
                    <div class="col-md-5">
                        <div class="download_moblie">
                            <div class="download_m_slider">
                                <img src="templates/themes/base/img/mobile-1.png" alt="">
                                <div class="download_moblile_slider owl-carousel owl-theme owl-loaded">
                                    <div class="owl-stage-outer">
                                        <div class="owl-stage">
                                            <div class="owl-item cloned">
                                                <div class="item">
                                                    <img src="templates/themes/base/img/screen-1.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
